...
// File: contracts/token/BEP20/Harvest.sol
...
/**
 * @title Harvest
 * @dev Implementation of the Harvest
 */
contract Harvest is BEP20Capped, BEP20Mintable, ServicePayer {
    ...
    constructor (
        ...
        BEP20(name, symbol)
        BEP20Capped(cap)
        ServicePayer(feeReceiver, "Harvest")
        payable
    {
