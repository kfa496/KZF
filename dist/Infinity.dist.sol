...
// File: contracts/token/BEP20/Infinity.sol
...
/**
 * @title Infinity
 * @dev Implementation of the Infinity
 */
contract Infinity is BEP20Mintable, BEP20Burnable, ServicePayer {
    ...
    constructor (
      ...
      BEP20(name, symbol)
      ServicePayer(feeReceiver, "Infinity")
      payable
    {
